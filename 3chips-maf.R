...
# SNPs not in the intersection of 3 chips
...
write.table(eur_only[,1:5], "maf_eur_only.txt", row.names = FALSE, col.names = FALSE, quote = FALSE)
...
write.table(afr_only[,1:5], "maf_afr_only.txt", row.names = FALSE, col.names = FALSE, quote = FALSE)
...
write.table(lat_only[,1:5], "maf_lat_only.txt", row.names = FALSE, col.names = FALSE, quote = FALSE)
