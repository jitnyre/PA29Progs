...
write.table(cbind(heur1[,c(1:6)],hafr1[,6],hlat1[,6],d), "hwe_all3.txt", row.names = FALSE, col.names = FALSE, quote = FALSE)
}
...
write.table(cbind(heur1[,c(1:6)],hafr1[,6],d), "hwe_eur_afr_notin3.txt", row.names = FALSE, col.names = FALSE, quote = FALSE)
}
...
write.table(cbind(heur1[,c(1:6)],hlat1[,6],d), "hwe_eur_lat_notin3.txt", row.names = FALSE, col.names = FALSE, quote = FALSE)
}
...
write.table(cbind(hafr1[,1:6],hlat1[,6],d), "hwe_afr_lat_notin3.txt", row.names = FALSE, col.names = FALSE, quote = FALSE)
}
...
write.table(heur1, "hwe_eur_only.txt", row.names = FALSE, col.names = FALSE, quote = FALSE)
...
write.table(hafr1, "hwe_afr_only.txt", row.names = FALSE, col.names = FALSE, quote = FALSE)
...
write.table(hlat1, "hwe_lat_only.txt", row.names = FALSE, col.names = FALSE, quote = FALSE)
